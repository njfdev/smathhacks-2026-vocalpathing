...
waveform, _ = librosa.load(
    "your_audio.wav", sr=10000, mono=True
...
outputs["scores"] = torch.sigmoid(
    torch.from_numpy(outputs["scores"].numpy())
)  # change to pytorch tensor and change to 0-1 probabalites
